...
export const translations: Record<Locale, Translations> = {
  ...
  zh: {
    ...
    nodesDetail: {
      ...
      revoked: '已撤销',
      bindings: '执行节点绑定',
      bindingsSub: '将代理绑定到特定节点以使用 exec host=node。',
      save: '保存',
      saving: '保存中…',
      switchToFormMode: '将配置选项卡切换到表单模式以在此处编辑绑定。',
      ...
      node: '节点',
      anyNode: '任意节点',
      noNodesSystemRun: '没有支持 system.run 的节点。',
      noAgents: '未找到代理。',
      binding: '绑定',
      useDefault: '使用默认',
      defaultAgent: '默认代理',
      ...
      override: '覆盖：{0}',
      execApprovals: '执行批准',
      execApprovalsSub: 'exec host=gateway/node 的允许列表和批准策略。',
      loadExecApprovals: '加载执行批准以编辑允许列表。',
      loadApprovals: '加载批准',
      target: '目标',
      targetDesc: '网关编辑本地批准；节点编辑选定的节点。',
      host: '主机',
      gateway: '网关',
      selectNode: '选择节点',
      noNodesExecApprovals: '尚未有节点通告执行批准功能。',
      scope: '范围',
      defaults: '默认值',
      security: '安全性',
      securityDesc: '默认安全模式。',
      ...
      autoAllowSkillsDesc: '允许网关列出的技能可执行文件。',
