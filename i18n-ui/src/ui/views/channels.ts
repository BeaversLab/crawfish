  ...
  return html`
    ...
    <section class="card" style="margin-top: 18px;">
      <div class="row" style="justify-content: space-between;">
        <div>
          <div class="card-title">${t("channelsDetail.channelHealth")}</div>
          <div class="card-sub">${t("channelsDetail.channelSnapshotSub")}</div>
        </div>
...
${props.snapshot ? JSON.stringify(props.snapshot, null, 2) : t("channelsDetail.noSnapshot")}
      </pre>
    </section>
  `;
}
...
function renderGenericChannelCard(
  ...
  return html`
    <div class="card">
      ...
      <div class="card-sub">${t("channelsDetail.channelConfigSub")}</div>
      ${accountCountLabel}
        ...
        accounts.length > 0
          ...
          : html`
            <div class="status-list" style="margin-top: 16px;">
              <div>
                <span class="label">${t("channelsDetail.configured")}</span>
                <span>${configured == null ? "n/a" : configured ? t("common.yes") : t("common.no")}</span>
              </div>
              <div>
                <span class="label">${t("channelsDetail.running")}</span>
                <span>${running == null ? "n/a" : running ? t("common.yes") : t("common.no")}</span>
              </div>
              <div>
                <span class="label">${t("channelsDetail.connected")}</span>
  ...
  return html`
    <div class="account-card">
      ...
      <div class="status-list account-card-status">
        ...
        <div>
          <span class="label">${t("channelsDetail.lastInbound")}</span>
