    ...
    <section class="grid grid-cols-2">
      <div class="card">
        ...
        <div class="form-grid" style="margin-top: 16px;">
          <label class="field">
            <span>${t("channelsDetail.server")}</span>
            <input
              ...
              placeholder="${t("overview.gatewayPlaceholder")}"
            />
          </label>
          <label class="field">
            <span>${t("channelsDetail.token")}</span>
            <input
          ...
          <label class="field">
            <span>${t("channelsDetail.password")}</span>
            <input
              type="password"
          ...
          <label class="field">
            <span>${t("sessionsDetail.key")}</span>
            <input
        ...
        <div class="row" style="margin-top: 14px;">
          <button class="btn" @click=${() => props.onConnect()}>${t("common.confirm")}</button>
        ...
        <div class="stat-grid" style="margin-top: 16px;">
          <div class="stat">
            ...
            <div class="stat-value ${props.connected ? "ok" : "warn"}">
              ${props.connected ? t("channelsDetail.connected") : t("channelsDetail.disconnected")}
            </div>
          </div>
          <div class="stat">
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="note-grid" style="margin-top: 14px;">
        <div>
          ...
          <div class="muted">
            ${t("overview.tailscaleDesc")}
          </div>
        </div>
        <div>
          <div class="note-title">${t("overview.sessionTitle")}</div>
          <div class="muted">${t("overview.sessionDesc")}</div>
        </div>
        <div>
          <div class="note-title">${t("overview.cronTitle")}</div>
          <div class="muted">${t("overview.cronDesc")}</div>
        </div>
      </div>
    </section>
  `;
